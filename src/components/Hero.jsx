...
import Resume from '../assets/Nandeesh_Resume.pdf'
         ...
         <div className='flex flex-wrap'>
            <div className='w-full lg:w-1/2'>
               <div className='flex flex-col items-center lg:items-start'>
                  ...
                  <div>
                     <a href={Resume} download="Nandeesh_Resume.pdf" className='w-6 h-6 md:w-8 md:h-8'>
            ...
            <div className="w-full lg:w-1/2 lg:p-8">
               <div className="flex justify-center">
                  <motion.img
                     ...
                     className=" h-[500px] shadow-lg shadow-gray-500"
                     src={profilePic}
                     alt="Nandeesh Ballanaguddam" />
               </div>
            </div>
         </div>
      </div>
